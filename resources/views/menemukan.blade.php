...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('assets/css/menemukan.css')}}">
        ...
        <div class="content">
            <form action="user-minuman.php" method="get">
                <div class="search-container">
                    <input class="search-input" type="search" id="searchInput" name="search" placeholder="">
...
<div class="image-box">
  <a href=""></a>
    ...
    <div class="caption">
        Ini adalah keterangan foto yang menarik. Anda dapat menulis deskripsi atau informasi penting tentang foto ini di sini.
    </div>
</div>
<br>
<br>
